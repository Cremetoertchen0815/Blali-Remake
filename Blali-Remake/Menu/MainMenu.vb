...
Namespace Menu
    ...
    Public Class MainMenu
        ...
        Public Overrides Sub Initialize()
            ...
            CreateEntity("Buttons").SetLocalPosition(New Vector2(1920 / 3 - 350, 1020 / 3 - 75)).AddComponent(New PrototypeSpriteRenderer(350, 50 * 3.5))
        ...
        Public Overrides Sub Update()
            ...
            If mpos.X > 115 And mpos.Y > 177 AndAlso mpos.X < 463 And mpos.Y < 350 AndAlso OneshotPressed = True Then
                Core.Scene = New Games.Blali_1.Remastered.GameScene(0)
            End If
