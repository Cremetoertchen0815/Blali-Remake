...
Namespace Framework.Level.ObjectManager.Objects
    ...
    Public Class YellowCoin
        ...
        Public Overrides Sub Draw(gameTime As GameTime)
            SpriteBat.Draw(lvl.ItemMan.Textures(7), New Rectangle(CenterLocation.X - (Size.X / 2), CenterLocation.Y - (Size.Y / 2), Size.X, Size.Y), New Color(255, 255, 255, Alpha))
        End Sub
        ...
        Public Overrides Sub Init(lvlS As Level)
            lvl = lvlS
            If Not lvlS.ItemMan.Textures.ContainsKey(7) Then lvlS.ItemMan.Textures.Add(7, ContentMan.Load(Of Texture2D)("obj\5\coin_yellow"))
