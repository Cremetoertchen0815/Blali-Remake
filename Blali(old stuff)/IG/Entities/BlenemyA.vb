...
Namespace IG.Entities
    Public Class BlenemyA
        ...
        Private Const cOrangeRange As Integer = 500
        ...
        Public Overrides Sub Initialize()
            mPosition = mSpawn
            mAABB.halfSize = New Vector2(94, 96)
        ...
        Public Overrides Sub LoadContent(Optional playerid As Integer = 0)
            Spritesheet = ContentMan.Load(Of Texture2D)("entity\11\enemy_a")
        End Sub
        ...
        Public Overrides Sub Draw(gameTime As GameTime)
            If CulledIn Then
                ...
                SpriteBat.Draw(Spritesheet, rec, Nothing, ccA, 0, Vector2.Zero, SpriteEffects.None, 0.52)
            End If
        End Sub
        ...
        Public Overrides Function CullIn(camviewport As Rectangle) As Boolean
            ...
            Return camviewport.Intersects(CulledRectA)
        End Function
    End Class
End Namespace