...
namespace Nez
{
	...
	{
		// sprite effects
		internal static byte[] SpriteBlinkEffectBytes => GetFileResourceBytes("nez/effects/SpriteBlinkEffect.mgfxo");

		internal static byte[] SpriteLinesEffectBytes => GetFileResourceBytes("nez/effects/SpriteLines.mgfxo");

		internal static byte[] SpriteAlphaTestBytes => GetFileResourceBytes("nez/effects/SpriteAlphaTest.mgfxo");

		internal static byte[] CrosshatchBytes => GetFileResourceBytes("nez/effects/Crosshatch.mgfxo");

		internal static byte[] NoiseBytes => GetFileResourceBytes("nez/effects/Noise.mgfxo");

		internal static byte[] TwistBytes => GetFileResourceBytes("nez/effects/Twist.mgfxo");

		internal static byte[] DotsBytes => GetFileResourceBytes("nez/effects/Dots.mgfxo");

		internal static byte[] DissolveBytes => GetFileResourceBytes("nez/effects/Dissolve.mgfxo");

		// post processor effects
		internal static byte[] BloomCombineBytes => GetFileResourceBytes("nez/effects/BloomCombine.mgfxo");

		internal static byte[] BloomExtractBytes => GetFileResourceBytes("nez/effects/BloomExtract.mgfxo");
